...
- Follow the manuscript's language and the user's choices. For a Traditional Chinese manuscript with English figure labels, keep the caption and explanation in Traditional Chinese unless requested otherwise.
